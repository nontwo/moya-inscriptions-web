...
- the complete matrix also runs every day, on manual dispatch, and for `v*`
  tags through `Full Browser Regression`.
...
configuration. Unknown code paths default to smoke rather than silently
