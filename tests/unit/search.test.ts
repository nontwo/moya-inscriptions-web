...
describe('search() 组合筛选', () => {
  ...
  it('6.7 关键词 + province 组合', () => {
    ...
    expect(result.total).toBeGreaterThanOrEqual(1);
    expect(result.results.every((r: SiteSummary) => r.region.province === '陕西省')).toBe(true);
  });
});
