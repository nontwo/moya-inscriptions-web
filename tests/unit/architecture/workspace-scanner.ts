 ...
 * treating every JSON file as a database substitute. Small configuration,
 * localization and design-token JSON remain valid when their paths do not
 * carry dataset semantics.
 */
