...
export const CATALOG_IMPORT_FIELD_POLICY = {
  ...
  sourceId: { persistence: "RAW_ONLY", protection: "identity" },
  ...
  dynasty: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  dateText: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  province: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  prefecture: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  county: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  currentLocation: {
    persistence: "DEFERRED_PERSISTENCE",
    protection: "LEVEL_B",
  },
  currentCustodian: {
    persistence: "DEFERRED_PERSISTENCE",
  ...
  alias: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  aliasType: { persistence: "DEFERRED_PERSISTENCE", protection: "LEVEL_B" },
  sourceTitle: { persistence: "RAW_ONLY", protection: "LEVEL_B" },
  sourceTypeRaw: { persistence: "RAW_ONLY", protection: "LEVEL_B" },
  sourceUrl: { persistence: "RAW_ONLY", protection: "LEVEL_B" },
  sourceNote: { persistence: "RAW_ONLY", protection: "LEVEL_B" },
} as const;
