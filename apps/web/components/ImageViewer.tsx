      ...
      <div className="flex items-center justify-between px-4 py-3 bg-black/50 text-white">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-1 bg-white/10 hover:bg-white/20 rounded text-sm cursor-pointer"
          >
            -
          </button>
          <button
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white rounded-xl shadow-2xl p-4 max-w-sm z-10 animate-fade-in">
            <div className="flex items-start justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-medium text-ink-600">
                  {selectedAnn.label}
                </h4>
              </div>
              <button
                onClick={() => setSelectedAnn(null)}
                className="text-ink-300 hover:text-ink-500 cursor-pointer"
              >
                <X size={16} />
              </button>
            </div>
            ...
            {selectedAnn.calligraphyNote && (
              <p className="text-xs text-vermilion-500 mt-2 pt-2 border-t border-rice-200">
                {selectedAnn.calligraphyNote}
              </p>
            )}
          </div>
