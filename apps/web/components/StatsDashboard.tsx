  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="card-stone p-5">
        ...
        <PieChart
          data={stats.categoryDistribution.filter((c) => c.count > 0)}
        />
      </div>
      ...
      <div className="card-stone p-5">
        ...
        <BarChart
          data={stats.scriptTypeDistribution.filter((s) => s.count > 0)}
        />
      </div>
    ...
    <div className="space-y-2">
      {data.map((d) => (
        <div key={d.province} className="flex items-center gap-3 text-xs">
          <span className="w-12 text-right text-ink-500 flex-shrink-0">
            {d.province}
          </span>
