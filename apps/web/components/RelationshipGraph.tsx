    ...
    <div className="relative">
      <div className="flex items-center gap-2 mb-3">
        <button
          ...
          className="p-1.5 bg-white border border-rice-200 rounded hover:bg-rice-50 cursor-pointer"
        >
          <ZoomIn size={14} />
        </button>
        <button
      ...
      <div
        ref={containerRef}
        className="bg-rice-50 rounded-xl overflow-hidden border border-rice-200"
        style={{ height: 400 }}
      >
